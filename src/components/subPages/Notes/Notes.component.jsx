...
function Notes({ selectedPatient, notesData, loading }) {
  ...
  //#region additionalInformationRender = Additional Information report #TODO - Needs testing
  const additionalInformationRender = notesData.map(
    ({ id, AddtItem_Adds_Info }) => (
      <NotesRender key={id}>
        <NotesGrid>
          <NotesColumn>
            <ReportField
              data={AddtItem_Adds_Info ? AddtItem_Adds_Info : "Not recorded"}
            />
          </NotesColumn>
        </NotesGrid>
      </NotesRender>
  ...
  //#endregion /additionalInformationRender = Additional Information report
